...
import { COLLYDE_PRIMARY_BLUE_COLOR, DEFUALT_PROFILE, _scaleText, VERIFIED_ICON, TEXT_CONST } from "../../../shared";
    ...
    <View style={{ flexDirection: "row", flex: 1 }}>
      <Menu
        style={[
          ...
          bubbleWidth && bubbleWidth < Dimensions.get("window").width / 2
            ? { left: bubbleWidth }
            : { right: _scaleText(10).fontSize, left: _scaleText(Dimensions.get("window").width / 2).fontSize },
        ]}
        ref={_menu}
        button={
          <View
                ...
                <View style={styles.ringWrapper}>
                  <View style={styles.profileImgContainerWithBorder}>
                    <FastImage
                      source={
                        props.message &&
                        props.message._sender &&
                        props.message._sender.plainProfileUrl &&
                        checkURL(props.message._sender.plainProfileUrl)
                    ...
                    >
                      {isLoading && (
                        <View
                          style={[
                            styles.profileImg,
                            { backgroundColor: "gray", borderRadius: 5, opacity: 0.5, justifyContent: "center" },
                          ]}
                        >
                          <ActivityIndicator
                            size={"small"}
                            color={Platform.OS === "ios" ? "black" : "#66756a"}
                            animating={isLoading}
                          />
                        </View>
                      )}
        ...
        <View style={{ borderColor: "#707070" }}>
          {!_isImage(props) && (
            <MenuItem
              ...
              style={{ height: _scaleText(30).fontSize, borderColor: "#707070" }}
            >
              <Icon name={"copy"} color={"#424950"} size={_scaleText(10).fontSize} />
          ...
          <MenuItem
            ...
            style={{ height: _scaleText(30).fontSize, borderColor: "#707070" }}
          >
            <Icon name={"exclamation-triangle"} color={"#424950"} size={_scaleText(10).fontSize} />
          ...
          {props.isUserHost && (
            <MenuItem
              ...
              style={{ height: _scaleText(30).fontSize }}
            >
              <Icon name={"trash-alt"} color={"#424950"} size={_scaleText(10).fontSize} />
